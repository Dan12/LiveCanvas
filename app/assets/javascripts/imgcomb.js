function combImgs(i1,i2,elem1,elem2){
  ...
  function pasteToCanvas(canv1,elem1,canv2){
    ...
    for(var cop = 0; cop < copies; cop++){
      ...
      var size = randNum(20,80);
      //canv1.drawImage(tempImg,randNum(-150,150),randNum(-150,150), size, size);
      canv1.drawImage(tempImg,randNum(20,450),randNum(20,450), size, size);
    }
    console.log("Done");
    i1.src = elem1.toDataURL('image/png');
  }
